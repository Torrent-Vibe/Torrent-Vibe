...
const operationSchema = Type.Union([
  ...
  Type.Object({
    action: Type.Union([Type.Literal('recheck'), Type.Literal('reannounce')]),
    hashes: operationHashes,
  }),
  Type.Object({
